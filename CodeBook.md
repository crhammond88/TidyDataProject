...
##Project Information
The data is transformed from the original set to meet the following goals:
...
##Tidy Dataset
The tidy dataset produce by run_analysis.R contains the following columns:

"Activity" : The name of the activity performed (1 of 6) - "WALKING", "WALKING_DOWNSTAIRS", "WALKING_UPSTAIRS", "STANDING", "SITTING", "LAYING"

"Subject" : The identifying number for the person measured (1:24)

The remaining variables are the means or standard deviations of the variables measured by the wearables device:
